...
$merge_dicts = ($dict1, $dict2) -> {
    RETURN SetUnion($dict1, $dict2, ($_key, $a, $b) -> {
...
$count_values = AGGREGATION_FACTORY("UDAF", $create_single_item_dict, ($dict, $item, $parent) -> {
...
$count_list_values = AGGREGATION_FACTORY("UDAF", $create_dict_from_list, $add_list_to_dict, $merge_dicts);
