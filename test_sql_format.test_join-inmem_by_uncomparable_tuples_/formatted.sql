/* syntax version 1 */
$l = AsList(AsStruct(AsTuple(1, 2, 3) AS Key, "1,2,3" AS Lhs), AsStruct(AsTuple(1, 2, 4) AS Key, "1,2,4" AS Lhs));
$r = AsList(AsStruct(AsTuple(1, 2) AS Key, "1,2" AS Rhs), AsStruct(AsTuple(2, 3) AS Key, "2,3" AS Rhs));
SELECT
    Lhs,
    Rhs
FROM AS_TABLE($l)
