...
SELECT
    JSON_VALUE ($input_json, "strict $var" PASSING $int64_param AS var RETURNING Int64),
    JSON_VALUE ($input_json, "strict $var" PASSING $double_param AS var RETURNING Double),
